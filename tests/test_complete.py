...
class TestCache(unittest.TestCase):
    ...
    def test_nominal_case(self):
        actual_result = self.cache.get_completions(
                "/Users/simon/D")
    ...
    def test_empty_json(self):
        actual_result = Cache({}).get_completions(
                "/Users")
        expected_result = []
        self.assertEquals(expected_result, actual_result)
...
class TestGetCompletionsWithUpdate(unittest.TestCase):
    def testNoUpdate(self):
        ...
        path = "/Users/s"
        self.assertEquals(["/Users/simon/"], CacheCompleter(cache, lister_mock).get_completions(path))
    ...
    def testUpdate(self, load_cache_mock):
        ...
        self.assertEquals(["/Users/simon/Documents/", "/Users/simon/Dropbox/"],
                          CacheCompleter(cache, lister_mock).get_completions(path))
